  ...
  <div>
    ...
    <div id="layout">
      <div id="layout_up">
        ...
        <div id="main_pic">
          <img src="@/assets/anson/0610/Others_main.svg" />
        </div>
      </div>
      ...
      <div class="button_list">
        <div class="button_dark" @click="toRelax()">
          <div class="button_mark">
            <img src="@/assets/anson/0610/sports.svg" />
          </div>
          <div class="button_font">放鬆練習</div>
        </div>
        <div class="button_light" @click="toArticle()">
          <div class="button_mark">
            <img src="@/assets/anson/0610/article.svg" />
          </div>
          <div class="button_font">讀讀文章</div>
        </div>
      </div>
      ...
      <div class="button_list">
        <div class="button_light" @click="toMedical()">
          <div class="button_mark">
            <img src="@/assets/anson/0610/medical.svg" />
          </div>
          <div class="button_font">醫療院所</div>
        </div>
        <div class="button_dark" @click="toSupport()">
          <div class="button_mark">
            <img src="@/assets/anson/0610/support.svg" />
          </div>
          <div class="button_font">線上支持</div>
        </div>
      </div>
    </div>
